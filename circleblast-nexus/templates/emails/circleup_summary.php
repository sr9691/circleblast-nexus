...
<td style="text-align:center;padding:8px;"><span style="font-size:24px;font-weight:700;color:{{color_secondary}};">{{wins_count}}</span><br/><span style="font-size:12px;color:#666;">Wins</span></td>
<td style="text-align:center;padding:8px;"><span style="font-size:24px;font-weight:700;color:{{color_primary}};">{{insights_count}}</span><br/><span style="font-size:12px;color:#666;">Insights</span></td>
<td style="text-align:center;padding:8px;"><span style="font-size:24px;font-weight:700;color:{{color_primary}};">{{actions_count}}</span><br/><span style="font-size:12px;color:#666;">Actions</span></td>
</tr></table>
</div>
...
<p style="font-size:15px;color:#333;line-height:1.6;">Have a win or insight to share? <a href="{{quick_share_url}}" style="color:{{color_primary}};font-weight:600;">Share it now</a> — no login required.</p>
