...
return [
	'subject' => '🎉 {{candidate_name}} Has Joined The Circle!',
	'body'    => '
<p style="font-size:16px;color:#333;margin:0 0 16px;">Hi {{referrer_name}},</p>
<p style="font-size:15px;color:#333;line-height:1.6;margin:0 0 16px;">
Great news — <strong>{{candidate_name}}</strong> has been accepted into The Circle! Their member account has been created and they\'ve received a welcome email with instructions to get started.</p>
<p style="font-size:15px;color:#333;line-height:1.6;margin:0 0 16px;">
...
<p style="font-size:15px;color:#333;line-height:1.6;margin:0 0 8px;">Thank you for helping The Circle grow stronger.</p>
