 ...
 *
 * Each tab's render + handler logic lives in its own file under admin-tabs/.
 * This master file handles routing, tab navigation, shared helpers, and
 * action dispatch.
 */
...
// ─── Load tab modules ──────────────────────────────────────────────────
require_once __DIR__ . '/admin-tabs/class-portal-admin-members.php';
require_once __DIR__ . '/admin-tabs/class-portal-admin-recruitment.php';
require_once __DIR__ . '/admin-tabs/class-portal-admin-matching.php';
require_once __DIR__ . '/admin-tabs/class-portal-admin-archivist.php';
require_once __DIR__ . '/admin-tabs/class-portal-admin-events.php';
require_once __DIR__ . '/admin-tabs/class-portal-admin-analytics.php';
require_once __DIR__ . '/admin-tabs/class-portal-admin-emails.php';
require_once __DIR__ . '/admin-tabs/class-portal-admin-logs.php';
require_once __DIR__ . '/admin-tabs/class-portal-admin-settings.php';
...
final class CBNexus_Portal_Admin {
	...
	// ─── Actions (dispatch to tab handlers) ─────────────────────────────
	...
	// ─── Public Helpers (used by tab classes) ───────────────────────────
	...
	/**
	 * Public wrapper so WP-admin recruitment handler can also trigger automations.
	 * Delegates to the Recruitment tab class.
	 */
